...
const bookOne = new Books("Romeo and Juliet", "144", "William Shakespeare", "read");
const bookTwo = new Books("Harry Potter and the Sorcerer's Stone", "270", "J.K Rowling", "not read");
const bookThree = new Books("Song of Ice and Fire", "332", "G.R.R Martin", "Read");
